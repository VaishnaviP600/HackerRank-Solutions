...
def inclusive_range(arr, start_pos, end_pos)
  # return the elements between start_pos and end_pos (both inclusive)
  arr[start_pos..end_pos]
end

def non_inclusive_range(arr, start_pos, end_pos)
  # return the elements from start_pos (inclusive) to end_pos (exclusive)
  arr[start_pos...end_pos]
end

def start_and_length(arr, start_pos, length)
  # return `length` elements starting from `start_pos`
